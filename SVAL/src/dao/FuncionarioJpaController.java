...
public class FuncionarioJpaController implements Serializable {
    ...
    public List<Funcionario> findFuncionarioEntities() {
      ...
      public List<Usuario> findFuncionarioEntities1() {
        return findFuncionarioEntities1(true, -1, -1);
    }
    ...
    private List<Usuario> findFuncionarioEntities1(boolean all, int maxResults, int firstResult) {
        EntityManager em = getEntityManager();
        try {
            CriteriaQuery cq = em.getCriteriaBuilder().createQuery();
